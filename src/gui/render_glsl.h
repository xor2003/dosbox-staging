...
constexpr char advinterp2x_glsl[] = R"(
...
vec3 getadvinterp2xtexel(vec2 coord)
{
	...
	return mix(mix(l00, l01, coord.x),
	           mix(l10, l11, coord.x),
	           coord.y);
}
...
constexpr char advinterp3x_glsl[] = R"(
varying vec2 v_texCoord;
uniform sampler2D rubyTexture;
uniform vec2 rubyInputSize;
uniform vec2 rubyOutputSize;
...
constexpr char advmame2x_glsl[] = R"(
varying vec2 v_texCoord;
uniform sampler2D rubyTexture;
uniform vec2 rubyInputSize;
uniform vec2 rubyOutputSize;
...
constexpr char advmame3x_glsl[] = R"(
varying vec2 v_texCoord;
uniform sampler2D rubyTexture;
uniform vec2 rubyInputSize;
uniform vec2 rubyOutputSize;
