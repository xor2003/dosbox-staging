...
cs=0x1b2;eip=0x0000c7; 	T(INC(fruity));	// 250 inc     fruity ;~ 01B2:00C7
...
cs=0x1b2;eip=0x00018b; 	J(RETN(0));	// 373 retn ;~ 01B2:018B
    ...
    switch (__disp) {
        ...
        case m2c::kret_1b2_154: 	goto ret_1b2_154;
        case m2c::kret_1b2_15a: 	goto ret_1b2_15a;
...
cs=0x1b2;eip=0x0001f5; 	J(RETN(0));	// 449 retn ;~ 01B2:01F5
 ...
 bool shiftsnake(m2c::_offsets _i, struct m2c::_STATE* _state){
    ...
    shiftsnake:
    _begin:
cs=0x1b2;eip=0x0001f6; 	T(MOV(bx, offset(data,head)));	// 457 mov     bx, offset head[0] ;~ 01B2:01F6
...
cs=0x1b2;eip=0x000288; 	T(INC(segmentcount));	// 552 inc     segmentcount ;~ 01B2:0288
...
cs=0x1b2;eip=0x00029e; 	J(RETN(0));	// 558 retn ;~ 01B2:029E
    ...
    switch (__disp) {
        ...
        case m2c::kret_1b2_243: 	goto ret_1b2_243;
...
cs=0x1b2;eip=0x0002cd; 	J(RETN(0));	// 593 retn ;~ 01B2:02CD
    ...
    switch (__disp) {
        ...
        case m2c::kret_1b2_2ab: 	goto ret_1b2_2ab;
...
bool _group1(m2c::_offsets _i, struct m2c::_STATE* _state){
    ...
    _group1:
    _begin:
cs=0x1b2;eip=0x000000; asmmain:	// 124 
#undef argc
#define argc 2	// 126 argc            = dword ptr  2 ;~ 01B2:0000
#undef argv
#define argv 6	// 127 argv            = dword ptr  6 ;~ 01B2:0000
#undef envp
#define envp 0x0A	// 128 envp            = dword ptr  0Ah ;~ 01B2:0000
...
cs=0x1b2;eip=0x000092; delay:	// 206 
...
cs=0x1b2;eip=0x000098; loc_10198:	// 4384 
...
cs=0x1b2;eip=0x0000a2; 	J(RETN(0));	// 221 retn ;~ 01B2:00A2
    ...
    switch (__disp) {
        ...
        case m2c::kret_1b2_19: 	goto ret_1b2_19;
        case m2c::kret_1b2_30: 	goto ret_1b2_30;
        case m2c::kret_1b2_3a: 	goto ret_1b2_3a;
        case m2c::kret_1b2_3d: 	goto ret_1b2_3d;
        case m2c::kret_1b2_47: 	goto ret_1b2_47;
        case m2c::kret_1b2_51: 	goto ret_1b2_51;
        case m2c::kret_1b2_54: 	goto ret_1b2_54;
        case m2c::kret_1b2_6a: 	goto ret_1b2_6a;
 ...
 bool __dispatch_call(m2c::_offsets __i, struct m2c::_STATE* _state){
    ...
    switch (__i) {
        ...
        case m2c::kret_1b2_108: 	fruitgeneration(__disp, _state); break;
        case m2c::kloc_1023e: 	dispnum(__disp, _state); break;
        case m2c::kret_1b2_139: 	dispnum(__disp, _state); break;
        case m2c::kret_1b2_13d: 	dispnum(__disp, _state); break;
        case m2c::kloc_10268: 	draw(__disp, _state); break;
        case m2c::kloc_10279: 	draw(__disp, _state); break;
        case m2c::kret_1b2_154: 	draw(__disp, _state); break;
        case m2c::kret_1b2_15a: 	draw(__disp, _state); break;
        case m2c::kret_1b2_164: 	draw(__disp, _state); break;
        case m2c::kret_1b2_174: 	draw(__disp, _state); break;
        case m2c::kret_1b2_186: 	draw(__disp, _state); break;
        ...
        case m2c::kret_1b2_19f: 	keyboardfunctions(__disp, _state); break;
        ...
        case m2c::kret_1b2_243: 	shiftsnake(__disp, _state); break;
        case m2c::kret_1b2_255: 	shiftsnake(__disp, _state); break;
        case m2c::kret_1b2_299: 	shiftsnake(__disp, _state); break;
        ...
        case m2c::kret_1b2_2ab: 	printbox(__disp, _state); break;
        case m2c::kret_1b2_2b5: 	printbox(__disp, _state); break;
        case m2c::kret_1b2_2bf: 	printbox(__disp, _state); break;
        case m2c::kret_1b2_2c9: 	printbox(__disp, _state); break;
        case m2c::kloc_1044a: 	writestringat(__disp, _state); break;
        case m2c::kloc_10458: 	writestringat(__disp, _state); break;
        case m2c::kdelay: 	_group1(__disp, _state); break;
        case m2c::kloc_1012d: 	_group1(__disp, _state); break;
        case m2c::kloc_10156: 	_group1(__disp, _state); break;
        case m2c::kloc_1016f: 	_group1(__disp, _state); break;
        case m2c::kloc_10188: 	_group1(__disp, _state); break;
        case m2c::kloc_10198: 	_group1(__disp, _state); break;
        case m2c::kmain: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_19: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_30: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_3a: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_3d: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_47: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_51: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_54: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_6a: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_6d: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_83: 	_group1(__disp, _state); break;
        case m2c::kret_1b2_86: 	_group1(__disp, _state); break;
...
#endif
{
    ...
    {db tmp999=10;MYCOPY(dummyb_1ae5)} // 01a2:00c5
    {db tmp999=11;MYCOPY(dummyb_1ae6)} // 01a2:00c6
