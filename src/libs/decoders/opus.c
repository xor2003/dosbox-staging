/*
 * SDL_sound Ogg Opus decoder backend
 * Copyright (C) 2018 Kevin R Croft <krcroft -at- gmail.com>
 *
 ...
 *
 * Source links
 *   - libogg:     http://downloads.xiph.org/releases/ogg/libogg-1.3.3.tar.xz
 *   - libopus:    https://archive.mozilla.org/pub/opus/opus-1.3-beta.tar.gz
 *   - opusfile:   https://archive.mozilla.org/pub/opus/opusfile-0.9.tar.gz
 *   - speexdsp:   https://github.com/xiph/speexdsp/archive/SpeexDSP-1.2rc3.tar.gz
 *   - opus-tools: https://archive.mozilla.org/pub/opus/opus-tools-0.1.10.tar.gz
...
static Sint32 opus_open(Sound_Sample* sample, const char* ext)
{
	...
	internal->total_time = total_time == OP_EINVAL ? -1 : // total milliseconds in the stream
		                                 (Sint32)( (double)total_time / OPUS_SAMPLE_RATE_PER_MS + 0.5);
