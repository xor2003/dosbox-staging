...
void DOSBOX_Init(void) {
	...
	const char* banner_choices[] = { "auto", "yes", "no", 0};
	Pstring = secprop->Add_string("show_banners",Property::Changeable::OnlyAtStart,"auto");
	Pstring->Set_values(banner_choices);
	Pstring->Set_help("Decide if splash and intro banners will be shown.");
